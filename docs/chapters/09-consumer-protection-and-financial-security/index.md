...
168. Credit Monitoring
169. Password Security
170. Two-Factor Authentication
171. Phishing Scams
172. Ponzi Schemes
173. Pyramid Schemes
174. Consumer Rights
175. CFPB Protection
176. Dispute Resolution
177. Credit Freeze
...
- [Chapter 1: Foundational Financial Concepts](../01-foundational-financial-concepts/index.md) - Money management principles
- [Chapter 2: Banking and Cash Management](../02-banking-and-cash-management/index.md) - Banking security
- [Chapter 4: Credit and Debt Management](../04-credit-and-debt-management/index.md) - Credit scores and credit reports
- [Chapter 5: Saving and Investing](../05-saving-and-investing/index.md) - Investment fundamentals (to recognize investment scams)
...
1. **Gather documentation:** Proof the information is incorrect
2. **Dispute with credit bureau:** File online, by mail, or by phone
3. **Dispute with creditor:** Also notify the company that reported the error
4. **Bureau must investigate:** Usually within 30 days
5. **Follow up:** If not resolved, file additional disputes
6. **Add statement:** If unresolved, you can add 100-word statement to your report
...
How it works:
- Install app like Google Authenticator, Authy, or Microsoft Authenticator
- Scan QR code to set up
- App generates rotating 6-digit codes every 30 seconds
- Enter current code to log in

Advantages:
- More secure than SMS
- Works without cell service (uses device clock)
- Not vulnerable to SIM swapping
- Free and easy to use

Disadvantages:
- Need your phone
- If you lose phone, may need backup codes
- Must set up each account individually

**Push notifications (good security + convenience):**

How it works:
- Try to log in on computer
- Get notification on phone: "Are you trying to log in?"
- Approve or deny

Advantages:
- Very convenient
- Clear if someone else is trying to access your account
- Can't be phished (can't give someone a code you don't see)

Disadvantages:
- Requires app installation
- Requires internet connection on phone
- Easy to accidentally approve if you're not paying attention

**Hardware security keys (best security):**

How it works:
- Purchase physical security key (YubiKey, Titan Key, etc., $20-50)
- Register key with your accounts
- When logging in, insert key into USB port or tap it for NFC
- Press button on key to authenticate

Advantages:
- Strongest security available
- Impossible to phish (cryptographic proof, not a code you type)
- Works without battery or internet
- Can't be remotely hacked

Disadvantages:
- Costs money ($20-50 per key)
- Must carry physical item
- Can be lost (should register backup key)
...
1. **Email:** Most critical—email is used to reset other passwords
2. **Banking and financial accounts:** Protects your money directly
3. **Password manager:** Protects all your other passwords
4. **Social media:** Prevents impersonation and access to personal info
5. **Work accounts:** Protects employer data
6. **Cloud storage:** Google Drive, Dropbox, iCloud, etc.
7. **Shopping accounts:** Amazon, PayPal, etc. (stored payment methods)
8. **Crypto/investment accounts:** High-value targets

**How to enable 2FA:**

Most services call it "Two-Factor Authentication," "2-Step Verification," or "Security Key." Find it in account security settings:

1. Go to account security/privacy settings
2. Look for "Two-Factor Authentication" or "2-Step Verification"
3. Choose method (app, SMS, or security key)
4. Follow setup instructions
5. Save backup codes in password manager (used if you lose phone)
...
Typical scenario:
- Email appears to be from your bank, Amazon, IRS, etc.
- Claims there's a problem with your account
- Urgent language: "Your account will be closed!" or "Suspicious activity detected!"
- Link to a website that looks legitimate but is actually fake
- Fake site captures username, password, credit card numbers, SSN, etc.

Red flags:
- Unsolicited message about account problems
- Sense of urgency or threats
- Generic greetings ("Dear Customer" instead of your name)
- Spelling and grammar errors
- Suspicious sender address (check carefully—might be "amaozn.com" not "amazon.com")
- Link URLs don't match the company (hover over links to see real URL)
- Requests for sensitive information banks never ask for via email
...
Why it works:
- You see it on your phone immediately
- Shorter messages feel more urgent
...
Scenario:
- Call from "IRS" or "Social Security Administration"
- Threatens arrest, account closure, benefit suspension
- Demands immediate payment via gift cards, wire transfer, or cryptocurrency
- May spoof legitimate phone numbers to appear real

Reality:
- IRS never initiates contact by phone
- Government agencies don't demand gift cards
- Real agencies give you time to verify and respond
- Aggressive, threatening calls are always scams
...
1. Scammer promises high, consistent returns with little risk (e.g., "15% guaranteed monthly!")
2. Early investors receive promised returns (paid from new investors' money)
3. Early investors tell friends, bringing in new money
4. Scammer lives lavishly on invested funds
5. Eventually can't recruit enough new investors to pay old investors
6. Scheme collapses, most investors lose everything
...
1. Pay money to join the "business opportunity"
2. Earn money by recruiting others who also pay to join
3. Each recruit must recruit more people
4. Early participants may profit from those below them
5. Eventually runs out of new recruits
6. Bottom levels (majority of participants) lose their investment
...
1. Describe issue and what you want
2. Provide documentation
3. CFPB sends to company
4. Company investigates and responds
5. You review response
6. CFPB tracks outcome
...
1. Contact merchant first (often resolves issue quickly)
2. If unresolved, call credit card issuer
3. Follow up in writing within 60 days of statement date
4. Include account number, charge details, explanation
5. Issuer must acknowledge within 30 days
6. Must investigate and resolve within 90 days
7. Can't report you as delinquent while investigating
...
If merchant won't resolve:
- Credit card company investigates
- May issue provisional credit while investigating
- Final determination based on evidence
- You have strong protection as cardholder

### General Dispute Steps

For any consumer dispute:

1. **Document everything:** Save receipts, emails, photos, warranties
2. **Contact company directly:** Start with customer service
3. **Escalate if needed:** Ask for supervisor or manager
4. **Put it in writing:** Send formal complaint letter via certified mail
5. **File with regulators:** CFPB, state attorney general, FTC
6. **Consider alternatives:** Better Business Bureau, small claims court
7. **Review/publicize:** Leave honest reviews (helps others, pressures company)
...
1. **Equifax:** equifax.com/personal/credit-report-services/ or 800-349-9960
2. **Experian:** experian.com/freeze/ or 888-397-3742
3. **TransUnion:** transunion.com/credit-freeze or 888-909-8872

Process:
- Provide name, address, birthdate, Social Security number
- Answer security questions
- Receive PIN or password to manage freeze
- Keep PIN secure—you'll need it to unfreeze

**Temporarily lifting a freeze:**

When applying for credit, mortgage, apartment:
- Contact bureaus and provide PIN
- Choose time-limited lift (1 day, 3 days, specific date range)
- Or lift for specific creditor only
- Or permanently unfreeze
- Usually takes effect within 1 hour
