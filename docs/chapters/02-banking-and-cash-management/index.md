...
- [Chapter 1: Foundational Financial Concepts](../01-foundational-financial-concepts/index.md) - Particularly money management principles and financial decision making
...
1. **Gather information** - Get your bank statement (online or paper) and your personal records (receipts, transaction log, or budgeting app)

2. **Compare transactions** - Check that every transaction on your statement matches your records

3. **Identify discrepancies** - Look for:
...
4. **Investigate and resolve** - For legitimate discrepancies, update your records. For errors or fraud, contact your bank immediately.

5. **Update your balance** - After accounting for all transactions, your records should match the bank's statement
...
<details markdown="1">
    ...
    Visual style: Flowchart with interactive checkboxes and hover explanations

    Steps:
    1. Start: "Download Bank Statement"
       Hover text: "Access your statement through mobile app or website - usually under 'Statements' section"
       Checkbox: "Statement downloaded"

    2. Process: "Gather Personal Records"
       Hover text: "Collect receipts, check your budgeting app, or review your transaction log"
       Checkbox: "Records ready"

    3. Process: "Compare Beginning Balance"
       Hover text: "Does last month's ending balance equal this month's starting balance? If not, investigate why."
       Checkbox: "Balances match"

    4. Process: "Check Each Transaction"
       Hover text: "Go line by line through your statement. Mark off each transaction you recognize."
       Checkbox: "All transactions reviewed"

    5. Decision: "All Transactions Match?"
       Hover text: "Do all bank transactions appear in your records and vice versa?"

    6a. Process: "Investigate Discrepancies" (if No)
        Hover text: "Common causes: forgotten transactions, bank errors, pending items not yet cleared, or fraud"
        Sub-steps visible on click:
        - Check if transaction is pending
        - Review receipts for that date
        - Search email for automatic payment confirmations
        - Look for duplicate charges
        - Identify unauthorized transactions

    6b. Decision: "Error or Fraud?" (if discrepancy found)
        Hover text: "Determine if the discrepancy is an innocent mistake or potential fraud"

    7a. Process: "Contact Bank" (if error/fraud)
        Hover text: "Call fraud department immediately. Don't wait. They'll freeze your account and investigate."
        Checkbox: "Bank contacted"

    7b. Process: "Update Personal Records" (if your mistake)
        Hover text: "Add the missing transaction to your records. Adjust your budget if needed."
        Checkbox: "Records updated"

    8. Process: "Calculate Ending Balance"
       Hover text: "Beginning balance + deposits - withdrawals = ending balance"
       Formula displayed: $B_{end} = B_{start} + D - W$
       Checkbox: "Balance calculated"

    9. Decision: "Balances Match?"
       Hover text: "Does your calculated balance equal the bank's ending balance?"

    10. Process: "Mark Reconciliation Complete" (if Yes)
        Hover text: "Date your statement and save it. You're done for this month!"
        Celebration animation: Green checkmark

    11. Loop back to step 6a (if No)

    Color coding:
    - Green: Process steps
    - Yellow: Decision points
    - Red: Error/fraud path
    - Blue: Data gathering

    Interactive features:
    - Checkboxes that students can click as they complete each step
    - Progress bar showing completion percentage
    - Hover for detailed explanations at each step
...
**Typical ACH timing:**
- Same-day ACH: Processed within hours (increasingly common)
- Standard ACH: 1-3 business days (most common)
- Weekends and holidays don't count toward processing days

**Common uses for ACH:**
- Direct deposit of paychecks
- Paying bills to utility companies, credit cards, loans
...
- Closing on a house (down payment and closing costs)
- Large purchases requiring immediate guaranteed payment
...
**Popular P2P apps:**
- **Venmo** - Social payment app owned by PayPal, popular with younger users
- **Cash App** - By Square, offers additional features like Bitcoin and investing
- **Zelle** - Bank-backed system integrated into many banking apps
- **PayPal** - The original online payment service
- **Apple Pay** and **Google Pay** - Tech company offerings integrated with devices
...
<details markdown="1">
    ...
    Purpose: Help students choose the appropriate electronic payment method for different scenarios (Bloom's: Applying, Evaluating)

    Layout: Decision tree with scenario-based guidance

    Top level question: "What kind of payment do you need to make?"

    Branch 1: "Paying a friend or family member"
    - Amount < $1,000 → "Use P2P app (Venmo, Cash App, Zelle)" [Green checkmark]
      - Benefits shown: "Free, instant, convenient"
    - Amount > $1,000 → "Use ACH transfer or check" [Yellow caution]
      - Warning: "P2P apps have transaction limits"

    Branch 2: "Paying a bill"
    - Regular monthly bill → "Set up automatic ACH" [Green checkmark]
      - Benefits: "Free, automatic, never late"
    - One-time bill → "Use bank's bill pay" [Green checkmark]
      - Benefits: "Free, trackable, no stamps"

    Branch 3: "Large purchase (>$10,000)"
    - Time sensitive/real estate → "Wire transfer" [Red caution]
      - Note: "$15-35 fee, irreversible, guaranteed"
    - Not time sensitive → "ACH transfer" [Green checkmark]
      - Note: "Free, takes 1-3 days"

    Branch 4: "International payment"
    - Large amount/urgent → "Wire transfer" [Yellow]
      - Note: "$35-50 fee, same-day"
    - Small amount/not urgent → "PayPal or Wise" [Green]
      - Note: "Lower fees, 1-3 days"

    Branch 5: "Store purchase"
    - In person → "Debit card" [Green checkmark]
      - Note: "Instant, widely accepted"
    - Online → "Credit card preferred" [Blue info]
      - Note: "Better fraud protection"

    Interactive elements:
    - Click any scenario to see a detailed example
    - Hover over payment method to see typical fees and timing
    - Toggle between "lowest cost" and "fastest" recommendations
    - Link to "Learn more" for each payment type

    Visual style:
    - Clean flowchart with rounded boxes
    - Color coding: Green (recommended), Yellow (caution), Red (warning), Blue (info)
    - Icons for each payment method
    - Clear arrows showing decision flow

    Key insights highlighted:
    - "P2P apps are great for friends, not strangers"
    - "Wire transfers are expensive - use sparingly"
    - "ACH is free and sufficient for most needs"
    - "Never wire money to someone you don't know"

    Implementation: Interactive HTML/CSS/JavaScript decision tree
</details>

## Banking Security and Protection
...
- Losses from theft or fraud (though you have other protections for these)
...
<details markdown="1">
    ...
    Learning objective: Help students understand FDIC insurance limits and how coverage applies in different scenarios (Bloom's: Understanding, Applying)

    Canvas layout (900x700px):
    - Left side (500x700): Interactive account builder
    - Right side (400x700): Coverage visualization and summary

    Visual elements:
    Left panel:
    - Add account buttons: "Individual," "Joint," "IRA/Retirement," "Trust"
    - List of added accounts with balance sliders
    - Trash icon to remove accounts
    - Bank selector dropdown (shows if using multiple banks)

    Right panel:
    - Pie chart showing insured vs. uninsured amounts
    - Coverage summary box:
      - Total deposited: $X
      - Total insured: $Y
      - Uninsured amount: $Z (in red if > 0)
    - Risk meter: Green (fully insured) to Red (significant uninsured amounts)
    - Recommendations box

    Interactive controls:
    - Dropdown: Select bank ("Bank A," "Bank B," etc.)
    - Button: "Add Individual Account"
    - Button: "Add Joint Account"
    - Button: "Add Retirement Account (IRA)"
    - Button: "Add Trust Account"
    - For each account:
      - Slider: Account balance ($0 - $500,000)
      - For joint accounts: Checkbox "Equal ownership" (checked by default)
      - For trust accounts: Number input "Number of beneficiaries" (1-5)
    - Button: "Add Another Bank" (splits coverage)
    - Button: "Reset Scenario"

    Default scenario:
    Bank A:
    - Individual checking: $50,000
    - Individual savings: $225,000
    - Total: $275,000 deposited, $250,000 insured, $25,000 uninsured

    Pre-loaded scenario buttons:
    - "Recent college grad" - $15k checking, $10k savings → Fully insured
    - "Young professional" - $30k checking, $100k savings, $50k IRA → Fully insured
    - "Higher earner" - $50k checking, $300k savings → Partially insured
    - "Married couple" - Joint accounts demonstrating $500k coverage

    Behavior:
    - Real-time calculation as sliders move
    - Pie chart updates showing insured (green) vs uninsured (red) portions
    - When uninsured amount > 0, show warning and recommendations:
      - "Consider opening accounts at a second bank"
      - "Move excess to investment accounts (not FDIC insured but growth potential)"
      - "Consider trust accounts if you have beneficiaries"
    - Tooltips explain coverage rules
    - Click pie chart segments to see which accounts contribute to that portion

    Educational insights displayed:
    - "You're fully protected! All your deposits are insured."
    - "Warning: $X is not FDIC insured. Consider these options..."
    - "By using a second bank, you could insure an additional $250,000"
    - "Joint accounts double your coverage to $500,000 at this bank"

    Formula shown:
    - Individual/Joint single owner: max $250,000
    - Joint equal ownership: max $250,000 × 2 = $500,000
    - Retirement: max $250,000
    - Trust: max $250,000 × number of beneficiaries

    Implementation: p5.js with chart rendering, FDIC coverage calculation logic based on official rules
</details>

## Putting It All Together: Choosing and Managing Your Accounts
...
1. **Primary checking account** - Choose a bank with:
...
2. **High-yield savings account** - Separate from checking to reduce spending temptation:
...
3. **Emergency fund savings** - May be same as #2 or separate:
