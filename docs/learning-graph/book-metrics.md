...
| 3 | MicroSims | 17 | Recommended | Interactive simulations in docs/sims/ |
...
| 7 | Glossary Terms | 358 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 56 | Recommended | Questions in faq.md |
| 9 | Words | 120,073 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 19 | 19 | H4 headers starting with '#### Diagram:' |
| Equations | 28 | 27 | LaTeX expressions (inline and display) |
| Total Words | 120,073 | 66,357 | Words in markdown files |
| Links | 452 | 167 | Hyperlinks in markdown format |
| Equivalent Pages | 493 | 278 | Estimated pages (250 words/page + visuals) |
