...
description: Interactive HTML/CSS/JavaScript interactive image MicroSim for phishing email anatomy.
...
```html
<iframe src="https://dmccreary.github.io/personal-finance/sims/phishing-email-anatomy/main.html"
        height="450px"
        width="100%"
        scrolling="no"></iframe>
```
