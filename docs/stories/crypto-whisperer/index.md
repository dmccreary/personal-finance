...
Color palette: screen-glow blue dominant, gold coin accents, neon pink vertical short-video app highlights, warm skin tones, a single pulsing red alert dot in the corner of the phone UI, cream highlights on the title. Mood: hype meets unease — compelling and slightly sinister, like a dystopian anthology title card. Style: contemporary graphic-novel with social-media overlay elements, flat vector with soft gradients and subtle screen glare.
